...
![Imagen representativa. Te esperamos para la Foto grupal el viernes 6 de febrero, 2026 a las 12:30 h](foto_grupo.jpg){width=300}
...
for(nombre_grupo in names(grupos_posters)){
  ...
  for(i in 1:nrow(df)){
   ...
   # Limpiar espacios a
    ...
    bloque <- paste0(
      "\\begin{quote}\n",
      "\\textbf{Poster ", df$PosterNumber[i], ": ", df$Title[i], "} \\\\ \n",
      "\\textbf{", df$Title[i], "} \\\\ \n",
...
El código se encuentra disponible libremente en el repositorio \href{https://github.com/usuario/repositorio}{GitHub X}.}
\end{center}
\end{flushbottom}
